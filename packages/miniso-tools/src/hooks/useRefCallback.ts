...
export function useRefCallback<T extends (...args: any[]) => any>(callback: T | undefined): (...args: Parameters<T>) => ReturnType<T> | undefined
...
export default function useRefCallback<T extends (...args: any[]) => any>(callback: T | undefined): T | ((...args: Parameters<T>) => ReturnType<T> | undefined) {
